...
\item A basic central limit theorem says that the average of many independent identically distributed (iid) random variables approximately follows a normal distribution.
\item 

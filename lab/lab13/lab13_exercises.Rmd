...
# Theorhetical Exercises

1. Suppose we have the following matrix $\mathbb{X} = \begin{bmatrix} 36 & 24 & 12 \\ 24 & 24 & 0\\ 12 & 0 & 24\\\end{bmatrix}$. Find a vector $\mathbf{\alpha}$ s.t. $\mathbb{X}\mathbf{\alpha} = \mathbf{0}$

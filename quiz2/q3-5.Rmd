...
```
(a) Would any of the models (fit1-fit5) give the same coefficients? If yes, list them.
...
(c) Recall from homework that the matrix $\mathbf{\hat{b}} = (\hat{b}_1,\hat{b}_2)$ can be found by  
```{r}

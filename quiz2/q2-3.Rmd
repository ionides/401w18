...
(b) Suppose we're interested in the predicting the North American Sales of a shooting game released by Activision. Specify a row matrix $\mathbb{x^*}$ such that $y^* = \mathbb{x^*b}$ gives the least square predictor.
